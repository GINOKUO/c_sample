...
int main() {
    ...
    //char *host = "04y4komh0j.execute-api.ap-southeast-2.amazonaws.com"; // 目標 URI
    char *host = "192.168.50.176"; // 目標 URI
    char *PORT_NUM = "80"; // HTTP port
    
    char request[0xfff], response[0xfff]; // 請求 與 回應訊息
    char *requestLine = "GET /api/GetMAC HTTP/1.1\r\n"; // 請求行
    //char *requestLine = "GET /alpha/notification?did=1111111111&ev_id=2$ev_val=00&ev_seq=0 HTTP/1.1\r\n"; // 請求行
