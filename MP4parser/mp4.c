 ...
 *****************************************************************************/
int MP4_NextBox( stream_t *p_stream, mp4_box_t *p_box )
{
   mp4_box_t box;
...
int MP4_ReadBoxContainerRaw( stream_t *p_stream, mp4_box_t *p_container )
{
   ...
   do
   {
      ...
      p_container->p_last = p_box;
      		...
      		//printf("p_box %x size %d \n", p_box->i_type ,p_box->i_size); //gino

                //MP4_ReadBox_avcC(p_stream,p_box);	
 ...
 int MP4_ReadBoxContainerRawFromBuffer( stream_t *p_stream, mp4_box_t *p_container )
{
   mp4_box_t *p_box;
...
int MP4_ReadBoxContainerFromBuffer( stream_t *p_stream, mp4_box_t *p_container )
{
   if( p_container->i_size <= (size_t)mp4_box_headersize(p_container ) + 8 )
   {
      /* container is empty, 8 stand for the first header in this box */
...
int MP4_ReadBox_ftyp( stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_ftypFromBuffer( stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_mvhd(  stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_mdhd( stream_t *p_stream, mp4_box_t *p_box )
{
    uint16_t i_language;
    unsigned int i = 0;
...
int MP4_ReadBox_avcC( stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_avcCFromBuffer( stream_t *p_stream, mp4_box_t *p_box )
{
    mp4_box_data_avcC_t *p_avcC;
    int i;
...
int MP4_ReadBox_sample_mp4s( stream_t *p_stream, mp4_box_t *p_box )
{
   stream_seek( p_stream, p_box->i_pos + mp4_box_headersize( p_box ) + 8, SEEK_SET );
   MP4_ReadBoxContainerRaw( p_stream, p_box );
   return 1;
...
int MP4_ReadBox_stsd( stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_name( stream_t *p_stream, mp4_box_t *p_box )
{
...
int MP4_ReadBox_meta( stream_t *p_stream, mp4_box_t *p_box )
{
   uint8_t meta_data[8];
   int i_actually_read;
...
int MP4_ReadBox_metaFromBuffer( stream_t *p_stream, mp4_box_t *p_box )
{
   uint8_t meta_data[8];
   int i_actually_read;
...
/* For generic */
int MP4_ReadBox_default( stream_t *p_stream, mp4_box_t *p_box )
{
   if( !p_box->p_father )
   {
      goto unknown;
...
int MP4_ReadBox_defaultFromBuffer( stream_t *p_stream, mp4_box_t *p_box )
{
   if( !p_box->p_father )
   {
      goto unknown;
